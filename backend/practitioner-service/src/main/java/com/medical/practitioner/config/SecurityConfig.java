...
/**
 * Sécurité Spring — JWT stateless, OTP/inscription/login publics.
 * Les autres endpoints exigent un token valide ; la vérification fine du rôle est
 * faite par {@code @PreAuthorize} sur les contrôleurs.
 */
@Configuration
@EnableWebSecurity
