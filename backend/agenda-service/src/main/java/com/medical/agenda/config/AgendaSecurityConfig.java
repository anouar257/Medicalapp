        ...
        .authorizeHttpRequests(
            auth ->
                auth.requestMatchers(HttpMethod.OPTIONS, "/**")
                    ...
                    .permitAll()
                    .requestMatchers(HttpMethod.POST, "/api/appointment-types/sync")
                    .permitAll()
                    .requestMatchers(HttpMethod.DELETE, "/api/appointment-types/sync/**")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/doctors")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/doctors/by-external/**")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/reviews/practitioner/**")
                    .permitAll()
                    .anyRequest()
                    .authenticated())
